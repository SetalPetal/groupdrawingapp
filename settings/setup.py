...
class Layout():
    ...
    TOOLBAR_SECOND_ROW_Y = TOOLBAR_PADDING + DEFAULT_BUTTON_SIZE + DEFAULT_PADDING
    ...
    draw = {
        ...
        "BG_HEIGHT":DEFAULT_TOOL_HEIGHT,
        "ERASER_BUTTON_X":TOOLBAR_PADDING + DEFAULT_BUTTON_SIZE + DEFAULT_PADDING,
        "SLIDER_BG_X":TOOLBAR_PADDING + DEFAULT_BUTTON_SIZE + DEFAULT_PADDING,
        "SLIDER_BG_WIDTH":134,
        "SIZE_BG_X":(DEFAULT_BUTTON_SIZE + DEFAULT_PADDING) * 2 + TOOLBAR_PADDING,
        "SIZE_BG_WIDTH":93,
        "SIZE_SLIDER_X":TOOLBAR_PADDING + DEFAULT_BUTTON_SIZE + (DEFAULT_PADDING * 2),
        "SIZE_SLIDER_Y":TOOLBAR_PADDING + DEFAULT_PADDING,
        "SIZE_SLIDER_WIDTH":122,
        "SIZE_SLIDER_HEIGHT":25,
        "TEXT_BOX_X":(DEFAULT_BUTTON_SIZE * 3) + (DEFAULT_PADDING * 2) + MEDIUM_PADDING + TOOLBAR_PADDING,
        "TEXT_BOX_Y":TOOLBAR_PADDING + DEFAULT_BUTTON_SIZE + (DEFAULT_PADDING * 2),
        "TEXT_BOX_WIDTH":49,
        "TEXT_BOX_HEIGHT":23,
    }
    ...
    color = {
        ...
        "BG_HEIGHT":DEFAULT_TOOL_HEIGHT,
        "LABEL_X":MEDIUM_PADDING -1,
        "LABEL_HEIGHT":41,
        "SWATCH_COLOR_SIZE":23,
        "SWATCH_COLOR_Y":TOOLBAR_PADDING + DEFAULT_BUTTON_SIZE + (DEFAULT_PADDING * 2),
        "SWATCH_1_COLOR_X":TOOLBAR_PADDING + DEFAULT_PADDING,
        "SWATCH_2_X":TOOLBAR_PADDING + DEFAULT_BUTTON_SIZE + DEFAULT_PADDING,
        "SWATCH_2_COLOR_X":TOOLBAR_PADDING + DEFAULT_BUTTON_SIZE + DEFAULT_PADDING,
        "PICKER_X":TOOLBAR_PADDING + (DEFAULT_BUTTON_SIZE * 2 ) + (DEFAULT_PADDING * 2)
    }
    ...
    brush_style = {
        ...
        "LABEL_WIDTH":174,
        "LABEL_HEIGHT":41,
        "ICON_X":DEFAULT_PADDING + SMALL_PADDING,
        "ICON_Y":DEFAULT_PADDING + SMALL_PADDING,
        "DROPDOWN_WIDTH":_BRUSH_STYLE_WIDTH - DEFAULT_PADDING - 9,
        "DROPDOWN_HEIGHT":37
    }
    ...
    draw_shape = {
        ...
        "LABEL_WIDTH":174,
        "LABEL_HEIGHT":41,
        "BUTTON_X":DEFAULT_PADDING + SMALL_PADDING,
        "BUTTON_Y":DEFAULT_PADDING + SMALL_PADDING,
        "DROPDOWN_WIDTH":_BRUSH_STYLE_WIDTH - DEFAULT_PADDING - 9,
        "DROPDOWN_HEIGHT":37
    }
